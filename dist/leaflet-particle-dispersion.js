(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('chroma-js'), require('heatmap.js'), require('leaflet-heatmap-radius')) :
	typeof define === 'function' && define.amd ? define(['chroma-js', 'heatmap.js', 'leaflet-heatmap-radius'], factory) :
	(global['leaflet-particle-dispersion'] = factory(global.chroma,global.heatmap_js,global.HeatmapOverlay));
}(this, (function (chroma,heatmap_js,HeatmapOverlay) { 'use strict';

	chroma = chroma && chroma.hasOwnProperty('default') ? chroma['default'] : chroma;
	heatmap_js = heatmap_js && heatmap_js.hasOwnProperty('default') ? heatmap_js['default'] : heatmap_js;
	HeatmapOverlay = HeatmapOverlay && HeatmapOverlay.hasOwnProperty('default') ? HeatmapOverlay['default'] : HeatmapOverlay;
